...
<ol>
  ...
  <li>Построение онлайн калькулятора для выхода на заднную маржинальность, основываясь на показателях за предыдущий период </li>
...
<p>Как решал:<p>
<li>Вычисление показателей за текущий перод </li>
